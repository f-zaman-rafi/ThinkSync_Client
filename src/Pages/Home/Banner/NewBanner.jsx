    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 justify-end lg:py-16">
                <div className=" pt-20 lg:space-y-5 lg:w-2/5">
                    <p className="font-bold text-xl pl-3">Learning Experience</p>
                    ...
                    <div className="flex gap-2 items-center text-[22px] lg:text-[28px] font-bold font-protest-revolution lg:pl-24 pl-16 pt-3 lg:pt-0">
