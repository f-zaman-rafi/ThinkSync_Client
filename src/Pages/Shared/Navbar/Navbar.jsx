        ...
        <div className="">
            <div className="navbar absolute z-10 max-w-screen-2xl mx-auto lg:px-10 lg:pt-5 bg-transparent">
                <div className="navbar-start">
                    ...
                    <Link to={'/'}>
                        <p className="flex gap-2 items-end text-[#ff0000] text-sm font-bold lg:text-3xl font-stardos">
                ...
                <div className="navbar-end">
                    {user ? (
                        ...
                        <div className="flex gap-3">
                            <Link to='/sign-in' className="btn btn-ghost text-[#FFFF00]">Sign In</Link>
                            <Link to='/sign-up' className="btn btn-ghost text-[#FFFF00]">Sign Up</Link>
                        </div>
                    )}
                </div>
