        ...
        <div className="">
            <div className="navbar absolute z-10 max-w-screen-2xl mx-auto lg:px-10 lg:pt-5 bg-transparent">
                <div className="navbar-start">
                    ...
                    <Link to={'/'}>
                        <p className="flex lg:gap-2 items-end text-[#ff0000] text-xl font-bold lg:text-3xl font-stardos">
                ...
                <div className="navbar-end">
                    {user ? (
                        <div className="flex lg:gap-2 lg:justify-center items-center ">
                            <Link to="/dashboard"><p className="btn btn-md text-[#FFFF00] btn-ghost text-shadow-outline">Dashboard</p></Link>
                            <button onClick={handleLogOut} className="btn btn-md text-[#FFFF00] btn-ghost text-shadow-outline">Sign Out</button>
                            <p className=""><img className="lg:h-8 lg:w-8 h-6 w-6 rounded-full" src={user.photoURL} alt="userPhoto" /></p>
                        </div>
                    ) : (
                        <div className="flex lg:gap-2 lg:justify-center items-center">
                            <Link to='/sign-in' className="btn btn-md text-[#FFFF00] btn-ghost text-shadow-outline">Sign In</Link>
                            <Link to='/sign-up' className="btn btn-md text-[#FFFF00] btn-ghost text-shadow-outline">Sign Up</Link>
                        </div>
                    )}
                </div>
