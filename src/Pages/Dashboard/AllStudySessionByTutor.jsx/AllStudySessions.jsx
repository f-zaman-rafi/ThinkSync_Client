            ...
            <div className="my-12">
                <section className="container px-4 mx-auto">
                    <div className="flex items-center gap-x-3">
                        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Total Sessions: {sessionData.length}</h2>
                                                                        ...
                                                                        <div className="modal-box">
                                                                            ...
                                                                            <div className="mt-4">
                                                                                <div className="flex items-center justify-between">
                                                                                    <label name="role" className="block text-sm text-gray-800 dark:text-gray-200">Select options here</label>
                                                                                </div>
