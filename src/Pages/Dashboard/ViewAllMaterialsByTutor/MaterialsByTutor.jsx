            ...
            <div className="my-12">
                <section className="container px-4 mx-auto">
                    <div className="flex items-center gap-x-3">
                        <h2 className="text-lg font-medium text-stone-900 ">Total Materials: {materialsData.length}</h2>
                                    ...
                                    <table className="min-w-full divide-y divide-stone-200 dark:divide-stone-700">
...

                                        {
                                            materialsData.map(materials => (
                                                <tbody key={materials._id} className="bg-white divide-y divide-stone-200 dark:divide-stone-700 dark:bg-stone-900">
                                                    <tr>
                                                        <td className="px-4 py-4 text-sm font-medium text-stone-700 whitespace-nowrap">
                                                            <div className="inline-flex items-center gap-x-3">
                                                                ...
                                                                <div className="flex items-center gap-x-2">
                                                                    <div>
                                                                        <h2 className="font-medium text-stone-800 dark:text-white ">{materials.title}</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="px-4 py-4 text-sm text-stone-500 dark:text-stone-300 whitespace-nowrap">{materials.image.length > 50 ? `${materials.image.substring(0, 50)}...` : materials.image}
                                                        </td>
                                                        ...
                                                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div className="flex items-center gap-x-6">
                                                                ...
                                                                <div className="flex justify-center">
                                                                    ...
                                                                    <Link to={`/dashboard/update-materials/${materials._id}`}><button className="text-stone-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-stone-300 hover:text-yellow-500 focus:outline-none">
